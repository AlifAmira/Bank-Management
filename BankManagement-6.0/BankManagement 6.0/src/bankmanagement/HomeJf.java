...
public class HomeJf extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Login, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 60, 180, 40));

        Text.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bankmanagement/Home txt.png"))); // NOI18N
        Text.setText("jLabel1");
        getContentPane().add(Text, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 580, 370));
